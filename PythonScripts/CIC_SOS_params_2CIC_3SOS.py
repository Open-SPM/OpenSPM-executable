...
def _compute_full_design(Fs_in, fc):
    ...
    Computes:
      ...
      - Full 3-SOS Butterworth LPF (order 6)
    ...
    # -------- IIR design (6th order Butterworth) --------
    wn = fc / (Fs_eff / 2.0)
...
# plt.title("Final 6th-order Butterworth LPF (after 2 CIC decimators)")
# plt.legend()
# plt.tight_layout()
# plt.show()
